...
public class theCLAAAWWW extends SubsystemBase {
  ...
  public theCLAAAWWW() {
    ...
    /*
     * Left Motor - Leader
     * Right Motor - Follower - NEVER SET OR READ TO/FROM RIGHT MOTOR, DO ALL CALCULATIONS BASED ON LEFT MOTOR
     */
  ...
  public void periodic() {
    ...
    m_armMotorLeft.set(
      ...
      degreesToEncoderUnits(armAngle), 
      DemandType.ArbitraryFeedForward, 
      .2 * java.lang.Math.cos(encoderUnitsToDegrees(Math.toRadians(m_armMotorLeft.getSelectedSensorPosition()))));
  ...
  public void setArmPosition(ClawState State){
  clawState = State;
  }
  ...
  public void setArmMotorsAngle(double armAngle){
    m_armMotorLeft.set(ControlMode.MotionMagic, degreesToEncoderUnits(armAngle), DemandType.ArbitraryFeedForward, 0.07);
  ...
  public void setLeftArmMotor(double speed){
